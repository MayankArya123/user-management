...
export const hometabledata = [
  {
    id: 129361171,
    client: "Rolex leo",
    payment: <span className="text-success">$376.24</span>,
    status: (
      <span className="badge badge-primary light border-0">Completed</span>
    ),
  },
  {
    id: 129361178,
  ...
  },
  {
    id: 129361179,
    client: "Rolex leo",
    payment: <span className="text-warning">$254.24</span>,
    status: (
      <span className="badge badge-warning light border-0">Inprogress</span>
    ),
  },
  {
    id: 129361179,
    client: "Meview Otis",
    payment: <span className="text-danger">$254.24</span>,
    status: <span className="badge badge-danger light border-0">Pending</span>,
  },
  {
    id: 129361171,
    client: "Rolex leo",
...
export const navtabdata1 = [
  {
    ...
    name: "James Jr.",
    image: IMAGES.customers11,
    image2: IMAGES.customers22,
    action: (
      <Link
        to={"#"}
        className="badge badge-warning light badge-sm text-warning"
      >
        PENDING
      </Link>
    ),
  },
  {
    ...
    name: "Jakob Vetrovs",
    image: IMAGES.customers44,
    image2: IMAGES.customers33,
    action: (
      <Link to={"#"} className="badge badge-info light badge-sm text-info">
        ON PROGRESS
      </Link>
    ),
  },
...
export const navtabdata4 = [
  {
    ...
    image2: IMAGES.customers22,
    action: (
      <Link to={"#"} className="badge badge-danger light badge-sm text-danger">
        Closed
      </Link>
    ),
  },
...
export const tableData2 = [
  {
    ...
    status: <span className="badge badge-success light">Active</span>,
  },
  {
    number: "2",
    title: "User Forgot Password",
    status: <span className="badge badge-danger light">Inactive</span>,
  },
  {
    number: "3",
...
export const fileExtension = [
  {
    name: "CRUD Invoices",
    image: IMAGES.folderfile,
    status: "12 files",
    status2: "7 files",
  },
  {
    name: "Tower Hill Docs",
    image: IMAGES.folderfile,
    status: "17 files",
    status2: "3 files",
  },
  ...
  },
  {
    ...
    image: IMAGES.csvfile,
    status: "34 days ago",
    status2: "2 days ago",
  },
  {
    name: "Orders backup",
    image: IMAGES.cssfile,
    status: "03 days ago",
    status2: "2 days ago",
  },
  {
    name: "Avionica Tech.",
    image: IMAGES.pdffile,
    status: "04 days ago",
    status2: "2 days ago",
  },
  {
    name: "9 Degree CRUD.",
    image: IMAGES.htmlfile,
    status: "10 days ago",
    status2: "2 days ago",
  },
  {
    name: "User CRUD Styles",
    image: IMAGES.pptfile,
    status: "78 days ago",
    status2: "2 days ago",
  },
  {
    name: "Craft Logo",
    image: IMAGES.mp3file,
    status: "65 days ago",
    status2: "2 days ago",
  },
];
...
export const logsTable = [
  {
    status: "OK",
    statusClass: "success",
    action: "POST/project/WorldNIC/5482344/not_found",
    dateTime: "20 Dec 2024, 2:40 pm",
  },
  {
    status: "ERROR",
    statusClass: "danger",
    action: "POST/project/WorldNIC/5482344/invalid",
    dateTime: "25 Jul 2024, 5:30 pm",
  },
  {
    status: "ERROR",
    statusClass: "danger",
    action: "POST/project/WorldNIC/5482344/payment",
    dateTime: "20 Dec 2024, 2:40 pm",
  },
  {
    status: "OK",
...
export const galleryBlog = [
  { image: IMAGES.profile03 },
  { image: IMAGES.profile04 },
  { image: IMAGES.profile02 },
  { image: IMAGES.profile04 },
  { image: IMAGES.profile03 },
  { image: IMAGES.profile02 },
];
export const followersgrid = [
  {
    title: "Alan Green",
    para: "UI Designer",
    image: <img src={IMAGES.userspic1} alt="" className="rounded-circle" />,
  },
  {
    title: "Angela Moss",
    para: "Redblue Studios",
    image: (
      <span className="icon-placeholder bgl-success rounded-circle text-success">
        am
      </span>
    ),
  },
  {
    ...
    image: <img src={IMAGES.userspic2} alt="" className="rounded-circle" />,
  },
  {
    title: "Benny Chagur",
    para: "Highspeed Inc.",
    image: (
      <span className="icon-placeholder bgl-primary rounded-circle text-primary">
        Bc
      </span>
    ),
  },
  {
    title: "Chyntia Lawra",
    para: "Zero Two Studios",
    image: <img src={IMAGES.userspic3} alt="" className="rounded-circle" />,
  },
  {
    title: "Benny Chagur",
    para: "Highspeed Inc.",
...
export const projectgrid = [
  {
    image: IMAGES.logopic1,
    class: "bg-info",
    btn: (
      <span className="badge badge-success d-sm-inline-block d-none">
        Compeleted
      </span>
    ),
  },
  {
    image: IMAGES.logopic2,
    class: "bg-danger",
    btn: (
      <span className="badge badge-info d-sm-inline-block d-none">
        Compeleted
      </span>
    ),
  },
  {
    ...
    class: "bg-info",
    btn: (
      <span className="badge badge-danger d-sm-inline-block d-none">
        Incompleted
      </span>
    ),
  },
  {
    ...
    class: "bg-danger",
    btn: (
      <span className="badge badge-warning d-sm-inline-block d-none">
        Pending
      </span>
    ),
  },
...
export const productordertabeldata = [
  {
    ...
    status: (
      <span className="badge badge-success">
        {" "}
        Completed <span className="ms-1 fa fa-check" />{" "}
      </span>
    ),
    amount: "$99",
  },
  {
    ...
    status: (
      <span className="badge badge-primary">
        {" "}
        Processing <span className="ms-1 fa fa-redo" />{" "}
      </span>
    ),
    amount: "$120",
  },
  {
    ...
    status: (
      <span className="badge badge-secondary">
        {" "}
        On Hold <span className="ms-1 fa fa-ban" />{" "}
      </span>
    ),
    amount: "$70",
  },
  {
    ...
    status: (
      <span className="badge badge-warning">
        {" "}
        Pending <span className="ms-1 fas fa-stream" />{" "}
      </span>
    ),
    amount: "$92",
  },
...
export const notesdata = [
  {
    img: IMAGES.avatar1,
    name: "Yatin",
    para: "Meet with tailor",
    class: "bgl-success",
  },
  {
    img: IMAGES.avatar3,
    name: "Michel",
    para: "Meet with Mukund",
    class: "bgl-warning",
  },
  {
    img: IMAGES.avatar2,
    name: "John",
    para: "Meet with Nitesh",
    class: "bgl-danger",
  },
  {
    img: IMAGES.avatar3,
...
export const contactcarddata2 = [
  ...
  {
    title: "Cloe Simatupang",
    para: "Zero Two Studios",
    image: <img src={IMAGES.userspic4} alt="" className="rounded-circle" />,
  },
  {
    title: "Engeline O’conner",
    para: "Beep Beep Inc.",
    image: <img src={IMAGES.userspic5} alt="" className="rounded-circle" />,
  },
  {
    title: "Franklin Jr.",
    para: "Zero Two Studios",
    image: (
      <span className="icon-placeholder bgl-info rounded-circle text-info">
        jr
      </span>
    ),
  },
  {
    title: "Geovanny",
    para: "UI Designer",
    image: <img src={IMAGES.userspic6} alt="" className="rounded-circle" />,
  },
  {
    title: "Henry Charlotte",
    para: "UI Designer",
    image: (
      <span className="icon-placeholder bgl-info rounded-circle text-info">
        hc
  ...
  },
  {
    title: "Ivankov Shee",
    para: "UI Designer",
    image: <img src={IMAGES.userspic7} alt="" className="rounded-circle" />,
  },
  {
    title: "Nindy Leeacovic",
    para: "UI Designer",
    image: <img src={IMAGES.userspic8} alt="" className="rounded-circle" />,
  },
];
// inbox email
...
export const kanbandata = [
    ...
    content: [
      {
        ...
        span: (
          <span className="sub-title"> {SVGICON.designerdot} Deisgner </span>
        ),
        progessbar: "bg-design",
      },
      {
        ...
        span: (
          <span className="text-warning">
            {" "}
            {SVGICON.importantdot} Important{" "}
          </span>
        ),
        progessbar: "bg-warning",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        span: (
          <span className="text-danger"> {SVGICON.bugdot} BUGS FIXING </span>
        ),
        progessbar: "bg-danger",
      },
      {
        title: "Update information in footer section",
        span: (
      ...
      {
        title: "Create wireframe for landing page phase 1",
        span: <span className="sub-title"> {SVGICON.designerdot} HTML </span>,
        progessbar: "bg-design",
      },
    ],
  },
  {
    ...
    content: [
      {
        title: "Update information in footer section",
        span: <span className="sub-success"> {SVGICON.updatedot} UPDATE </span>,
        progessbar: "bg-success",
      },
      {
        title: "Update information in footer section",
        span: <span className="text-info"> {SVGICON.importantdot} Video </span>,
        progessbar: "bg-info",
      },
    ],
  },
