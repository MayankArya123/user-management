                  ...
                  <div className="ic-content px-2">
                    ...
                    <Link to="">
                      <h3 className="mt-2 mb-1">
                        Unlocking Business Efficiency With Sass Solutions{" "}
                      </h3>
                    </Link>
                    <p>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Labore laudantium libero incidunt.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="ic-blog-media">
                    ...
                    <div className="ic-blog-info">
                      ...
                      <div>
                        <h4>
                          <Link to="" className="text-white">
                            Embrace Luxury Living with our Elegant Couches
                          </Link>
                        </h4>
                      </div>
                    </div>
                ...
                <div className="card">
                  <div className="card-body ic-blog-grid p-2">
                    <div className="ic-blog-media">
                      <img
                        src={data.image}
                        className="w-100 rounded ic-post"
                        alt=""
                      />
                    </div>
                    <div className="ic-content p-2 pt-3">
                      ...
                      <Link to="">
                        <h4 className="mt-2">
                          The Role of SaaS Administration in Ensuring Data
                          Security
                        </h4>
                      </Link>
                      <p className="mb-0">
                        This post explores the critical role of SaaS
                        administrators in maintaining data security within
                        cloud-based applications
                      </p>
                      <div className="mt-2">
                        <img
                          src={IMAGES.contactpic2}
                          className="avatar rounded-circle me-1 avatar-sm"
                          alt=""
                        />
                  ...
                  <div className="card-body ic-blog-grid style-1 p-2">
                    ...
                    <div className="ic-content p-2 pt-3">
                      ...
                      <h5 className="card-title--medium">
                        <Link to="" className="text-dark">
                          Tuning an Acoustic and Electric Guitar in 6 Steps
                        </Link>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of has the printing and
                        has been typesetting industry.{" "}
                      </p>
