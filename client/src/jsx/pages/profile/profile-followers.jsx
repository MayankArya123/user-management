...
function ProfileFollowers() {
  const [active, setActive] = useState(
    new Array(artCardData.length).fill(false),
  );
              ...
              <div className="card">
                <div className="card-body text-center p-4">
                  <div className="mx-auto d-inline-block position-relative mb-3">
                    {item.text ? (
                      <div
                        className={` avatar avatar-lg  text-${item.textbg} rounded-circle mx-auto d-flex align-items-center justify-content-center bg-${item.textbg}-light`}
                      >
                        {item.textalpha}
                      </div>
                    ) : (
                      <img
                        src={item.image}
                        alt="avat"
                        className="rounded-circle avatar avatar-lg style-1"
                      />
                    )}
                  ...
                  <button
                    ...
                    className={`btn btn-info btn-follow me-1 mt-4 ${active[ind] ? "active" : ""}`}
                  >
                    <i
                      className={`la me-1 fs-14 ${active[ind] ? "la-check" : "la-user"}`}
                    />
