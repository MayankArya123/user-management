          ...
          <div className="mb-4">
            <ul className="d-flex align-items-center flex-wrap">
              ...
              <li>
                <Link
                  to={"/blog-category"}
                  className="btn btn-primary btn-sm me-1 mt-sm-0 mt-1"
                >
                  Add Blog Category
                </Link>
              </li>
                  ...
                  <div className="col-xl-2 col-lg-3 col-sm-4" key={ind}>
                    <div className="form-check mb-3">
                      <input
                        ...
                        value=""
                      />
                      <label className="form-check-label mb-0 text-nowrap">
                        {" "}
                        {item.title}{" "}
                      </label>
                    </div>
                        ...
                        <ul className="list-style-1 block">
                          ...
                          <li>
                            <div>
                              <label className="form-label mb-0 me-2">
                                {" "}
                                <i className="fa-solid fa-eye" /> Visible:{" "}
                              </label>
                ...
                <div className="filter cm-content-box box-primary">
                  <div className="content-title SlideToolHeader">
                    ...
                    <div className="tools">
                      <Link
                        to={"#"}
                        className={`SlideToolHeader ${state.collpase13 ? "collapse" : "expand"}`}
