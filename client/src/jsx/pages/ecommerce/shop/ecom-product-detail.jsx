    ...
    if (completed) {
      ...
      return (
        <div className="countdown text-center">
          <div className="date">
            <span className="time days text-primary">{days}</span>
            <span className="work-time">Days</span>
          </div>
          <div className="date">
            <span className="time hours text-primary">{hours}</span>
            <span className="work-time">Hours</span>
          </div>
          <div className="date">
            <span className="time mins text-primary">{minutes}</span>
            <span className="work-time">Minutess</span>
          </div>
          <div className="date">
            <span className="time secs text-primary">{seconds}</span>
                  ...
                  <div className="product-details-bx">
                    <div className="new-arrival-content pr">
                      ...
                      <div className="comment-review star-rating">
                        <ul className="mb-2">
                          <li>
                            <span className="badge badge-success badge-sm me-3">
                              #1 Best Seller
                            </span>
                          </li>
                          <li>
                          ...
                          <div className="col-xl-6 col-sm-6">
                            <div className="size-filter">
                              ...
                              >
                                ...
                                />
                                <label
                                  className="btn btn-outline-primary sharp sharp-xs me-2"
                                  htmlFor="btnradio1"
                                >
                                  XS
                                </label>
                                ...
                                />
                                <label
                                  className="btn btn-outline-primary sharp sharp-xs"
                                  htmlFor="btnradio5"
                                >
                                  XL
                                </label>
                          ...
                          <div className="col-xl-7 col-6">
                            <div className="ms-2">
                              <Link className="btn btn-primary" to="#">
                                <i className="flaticon-shopping-cart me-2" />
                                Add To Cart
                              </Link>
                            </div>
                          </div>
                            ...
                            <ul>
                              ...
                              <li className="social-bx">
                                ...
                                <span className="social-media">
                                  <Link
                                    to="https://www.facebook.com/dexignlab"
                                    target="_blank"
                                  >
                                ...
                                <span className="social-media">
                                  <Link
                                    to="https://www.instagram.com/dexignlab/"
                                    target="_blank"
                                  >
                                ...
                                <span className="social-media">
                                  <Link
                                    to="https://twitter.com/dexignlabs"
                                    target="_blank"
                                  >
                ...
                <div className="col-xl-3">
                  <div className="cart-detail">
                    ...
                    <div className="border-bottom d-flex align-items-center mt-4 pb-3">
                      <svg
                        className="me-3 svg-details"
                        height="20"
                        viewBox="1 1 511.99984 511"
                        width="20"
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey="Description">
                          <div className="detail-bx text-center mt-4">
                            <h5 className="card-title--medium">
                              Eco-friendly Products Revolution
                            </h5>
                            <p>
                            ...
                            <ul className=" feature-detail d-flex align-items-center justify-content-lg-center justify-content-start flex-wrap">
                              ...
                              <li>
                                <i className="fa-solid fa-check" />
                                <h5 className="mb-0">
                                  Timeless Beauty Secrets Revealed
                                </h5>
                              </li>
                              <li>
                                <i className="fa-solid fa-check" />
                                <h5 className="mb-0">
                                  Radiate Confidence Through Timeless Beauty
                                </h5>
                              </li>
                            </ul>
                          </div>
                              ...
                              <div className="d-flex align-items-strat">
                                ...
                                <div>
                                  ...
                                  <p>
                                    ...
                                    adipisicing elit. Qui quae, ipsum commodi
                                    rerum porro totam libero est.
                                  </p>
                                </div>
                              </div>
                            </div>
