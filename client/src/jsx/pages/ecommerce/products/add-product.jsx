              ...
              <div className="card h-auto">
                ...
                <div className="card-body">
                  <form>
                    ...
                    <label className="form-label required mt-3">
                      Discount Type
                    </label>
                    <Tab.Container defaultActiveKey="no_discount">
                      <Nav as="ul" className="nav nav-pills mb-4">
                        <Nav.Item as="li" className="nav-item">
                          <Nav.Link eventKey="no_discount" className="nav-link">
                            NO Discount
                          </Nav.Link>
                        </Nav.Item>
                        <Nav.Item as="li" className="nav-item">
                          <Nav.Link eventKey="percentage" className="nav-link">
                            Percentage
                          </Nav.Link>
                        </Nav.Item>
                        <Nav.Item as="li" className="nav-item">
                          <Nav.Link eventKey="fixed_price" className="nav-link">
                            Fixed Price
                          </Nav.Link>
                        </Nav.Item>
                      </Nav>
                    ...
                    <div className="avatar-upload d-flex align-items-center">
                      <div className=" position-relative ">
                        ...
                        <div className="change-btn d-flex align-items-center flex-wrap">
                          ...
                          <label
                            htmlFor="imageUpload"
                            className="btn btn-primary light ms-0"
                          >
                            Select Image
                          </label>
                        </div>
