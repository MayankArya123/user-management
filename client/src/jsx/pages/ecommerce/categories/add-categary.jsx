                      ...
                      <div className="check-ai">
                        <div className="form-check">
                          ...
                          <label
                            ...
                            htmlFor="ManualInput"
                          >
                            <span className="text-dark d-block font-w600 fs-15 mb-2">
                              Manual
                            </span>
                            <span>
                        ...
                        <div className="row">
                          <div className="col-xl-3">
                            <div className="mb-3">
                              ...
                              <select
                                className=" default-select w-100"
                          ...
                          <div className="col-xl-3 align-self-end">
                            <div className="mb-3">
                              ...
                              >
                                {" "}
                                <i className="fa-solid fa-plus me-3"></i>Add
                                another condition
                              </button>
                            </div>
                          </div>
