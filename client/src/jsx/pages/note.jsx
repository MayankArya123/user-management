            ...
            <div className="card-body p-0">
              <div className="row g-0">
                <div className="col-xl-2 col-xxl-3">
                  <div
                    className={`mail-left-body dz-resp-tab ${active ? "active" : ""}`}
                  >
                    <div className=" ps-4 pe-3 py-4 ic-scroll height800">
                      <div className="mb-3 mt-4 mt-sm-0 email-left-box">
                        ...
                        <div className="mail-list">
                          ...
                          <Link to="/email-inbox" className="list-group-item">
                            <i className="fa-regular fa-star" /> Favourites{" "}
                          </Link>
                        </div>
                        <div className="mail-list">
                          ...
                          <Link to={"#"} className="list-group-item ">
                            ...
                            >
                              <path
                                d="M15.4425 10.0575L10.065 15.435C9.92569 15.5745 9.76026 15.6851 9.57816 15.7606C9.39606 15.8361 9.20087 15.8749 9.00375 15.8749C8.80663 15.8749 8.61144 15.8361 8.42934 15.7606C8.24724 15.6851 8.08181 15.5745 7.9425 15.435L1.5 9V1.5H9L15.4425 7.9425C15.7219 8.22354 15.8787 8.60372 15.8787 9C15.8787 9.39628 15.7219 9.77646 15.4425 10.0575Z"
                                stroke="var(--primary)"
                                strokeWidth="2"
                                strokeLinecap="round"
                  ...
                  <div className="p-4">
                    <div className="row">
                      <div className="d-flex align-items-center p-3">
                        <h4 className="d-xl-none d-lg-block card-title--medium mb-0">
                          Notes
                        </h4>
                        <div
                          className={`email-tools-box dz-resp-tool ms-auto float-end ${active ? "active" : ""}`}
                        ...
                        <div className="col-xl-4" key={i}>
                          <div className={`card ic-send-bx ${data.class}`}>
                            <div className="card-header align-items-strat border-0 pb-0">
                              ...
                              />
                              <div>
                                <h4 className="card-title--medium mb-0">
                                  {data.name}
                                </h4>
                                <small>11/01/2025</small>
                              </div>
                              <Dropdown
                                className="action-dropdown ms-auto align-self-start"
                                align="end"
                              >
                                <Dropdown.Toggle
                                  as="div"
                                ...
                                <Dropdown.Menu class="dropdown-menu dropdown-menu-end">
                                  <Dropdown.Item
                                    className="text-warning dropdown-item edit"
                                    onClick={() => setReviewToggle(true)}
                                  >
                                    edit
                                  </Dropdown.Item>
                            ...
                            <div className="card-footer d-flex align-items-center border-0 pt-0">
                              ...
                              <div className="ms-auto dz-dropdown">
                                <Dropdown
                                  className="default-select status-select c-pointer px-2 py-1 rounded"
                                  align="end"
                                  style={{
            ...
            <div className="row">
              <div className="col-xl-12">
                ...
                <div className="mb-3 dz-dropdown">
                  ...
                  <Form.Select
                    as="ul"
                    className="default-select status-select w-100"
                  >
        ...
        <div className="modal-content">
          <div className="modal-header">
            ...
            <button
              ...
              className="btn-close"
              aria-label="Close"
              onClick={() => setReviewToggle2(false)}
            >
              {" "}
            </button>
          </div>
