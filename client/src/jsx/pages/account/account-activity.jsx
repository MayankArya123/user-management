            ...
            <div className="card">
              <Tab.Container defaultActiveKey={"Week"}>
                <div className="card-header py-3 d-block d-sm-flex">
                  ...
                  <Nav
                    as="ul"
                    className="nav nav-pills mt-3 mt-sm-0 mix-chart-tab"
                    id="myTab"
                  >
                      ...
                      <div className="widget-timeline-icons pb-3">
                        <ul className="timeline">
                          <li>
                            ...
                            <div className="timeline-panel">
                              <div className="clearfix">
                                <span className="fs-14 fw-semibold text-black">
                              ...
                              <div className="px-3 py-3 mt-3 border border-secondary border-opacity-10 rounded">
                                <div className="row align-items-center">
                                  ...
                                  <div className="col-xxl-2 col-xl-2 col-sm-3 col-6 text-end mt-2 mt-sm-0">
                                    <Link
                                      to={"#"}
                                      className="btn btn-xxs btn-light text-black"
                                    >
                                      View
                                    </Link>
                                  </div>
                          ...
                          <li>
                            ...
                            <div className="timeline-panel">
                              <div className="clearfix">
                                <span className=" text-black fs-14 fw-semibold">
                                  Mashable, a news website and blog, goes live
                                </span>
                                <span className="fs-14 d-block">
                                  04:12 PM by{" "}
                                  <span className="text-primary">Jackson</span>
                                </span>
                              </div>
                            </div>
                          </li>
                            ...
                            <div className="timeline-panel">
                              <div className="clearfix">
                                <span className="text-black fs-14 fw-semibold">
                                  ...
                                  was merged into <strong>Google</strong> Task
                                  task
                                </span>
                                <span className="fs-14 d-block">
                                  12:38 PM by{" "}
                          ...
                          <li>
                            ...
                            <div className="timeline-panel">
                              <div className="clearfix">
                                <span className="text-black fs-14 fw-semibold">
                                  <strong>Hughes</strong> Created & assigned a
                                  new task{" "}
                                ...
                                <span className="fs-14 d-block">
                                  11:02 PM by{" "}
                                  <span className="text-primary">Hughes</span>
                                </span>
                              </div>
                            </div>
                          </li>
                          ...
                          <li>
                            ...
                            <div className="timeline-panel">
                              <div className="clearfix">
                                <span className="text-black fs-14 fw-semibold">
                                  <strong>Hughes</strong> Fold Created &
                                  assigned a new task{" "}
                                  <Link to={"#"} className="text-primary">
                                    Design Multistep Registraion Form
                                  </Link>{" "}
                                ...
                                <div className="col-lg-8">
                                  <div className="alert alert-primary border-primary outline-dashed py-3 px-4 d-flex align-items-center mb-0 mt-3">
                                    ...
                                    <div className="mx-3">
                                      ...
                                      <p className="fs-14 mb-0 text-black">
                                        Securely withdraw money to your bank
                                        account, with a $25 fee.
                                      </p>
                                    </div>
                                  </div>
                                </div>
