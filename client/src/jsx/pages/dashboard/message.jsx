                  ...
                  <Tab.Container defaultActiveKey="home-tab">
                    <div className="p-4 meassge-left-side">
                      <div className="d-flex align-items-center justify-content-between mb-3">
                        <div>
                          <span className="fs-24 font-w700 mb-0 text-dark me-2">
                            Inbox
                          </span>
                          <span className="fs-18 font-w600 text-light">
                            (2,456)
                          </span>
                        </div>
                        ...
                        <div className="chat-sidebar" id="chatSidebar">
                          ...
                          <div className="chat-bx d-flex active mb-2 border-bottom">
                            ...
                            <div className="w-100">
                              ...
                              <p className="mb-0">
                                Hey Jenny, don’t forget to prepare prototype for
                                next week
                              </p>
                            </div>
                          </div>
                ...
                <div className="col-xl-9 col-xxl-8">
                  <div className="d-flex justify-content-between align-items-center border-bottom px-4 pt-4 flex-wrap">
                    <div className="d-flex align-items-center pb-3">
                      ...
                      <div className="ms-3">
                        <h4 className="fs-20 mb-1 font-w700">
                          <Link to="/app-profile" className="text-dark">
                            Rayna Carder
                          </Link>
                        </h4>
                  ...
                  <div
                    className="chat-box-area ic-scroll chat-box-area"
                    id="chatArea"
                  >
                  ...
                  <div className="card-footer border-0 type-massage">
                    <div className="input-group">
                      <textarea
                        ...
                        rows="3"
                        placeholder="I think we should get that project in this month"
                      ></textarea>
                    </div>
                    <div className="input-group-append d-flex justify-content-between flex-wrap">
                      <div>
                        ...
                        <button type="button" className="btn pr-0">
                          <i className="fas fa-smile scale5 text-primary" />
                        </button>
