            ...
            <div className="card-body pt-2">
              <div className="d-flex align-items-center justify-content-between">
                <div>
                  ...
                  <span>
                    <small className="text-success font-w600 me-1">+1.6%</small>
                    than last week
                  </span>
                </div>
            ...
            <div className="card-body pt-2">
              <div className="d-flex align-items-center justify-content-between">
                <div>
                  ...
                  <span>
                    <small className="text-danger font-w600 me-1">-1.6%</small>
                    than last week
                  </span>
                </div>
                <div id="chart">
              ...
              <Tab.Container defaultActiveKey="social">
                <Nav className="nav nav-pills success-tab">
                  <Nav.Item className="nav-item">
                    <Nav.Link eventKey="social" className="nav-link">
                      {SVGICON.socialheart} <span>Social</span>
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item className="nav-item">
                    <Nav.Link eventKey="project" className="nav-link">
                      {" "}
                      {SVGICON.project} <span>Project</span>
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item className="nav-item">
                    <Nav.Link eventKey="sale" className="nav-link">
                      {SVGICON.scale} <span>Sale</span>
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item className="nav-item">
                    <Nav.Link eventKey="mobile" className="nav-link">
                      {SVGICON.mobile} <span>Mobile</span>
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item className="nav-item">
                    <Nav.Link eventKey="all" className="nav-link">
                      {SVGICON.all} <span>All</span>
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
                <Tab.Content>
                ...
                <ul className="timeline">
                  ...
                  <li>
                    ...
                    <div className="timeline-panel">
                      {" "}
                      <span>
                        shared this on my fb wall a few months back.
                      </span>{" "}
                    </div>
                  </li>
                  <li>
