            ...
            <div className="card-body">
              <div className="row">
                <div className="col-xl-7 col-xxl-6">
                  <h3 className="font-w600">
                    WorldNIC Company Profile Websites
                  </h3>
                  <p>
                    Created by <strong className="text-black">WorldNIC</strong>{" "}
                    on July 15, 2024
                  </p>
                  <p>
                    ...
                    <Link
                      to="https://worldnic.dexignlab.com/"
                      className="text-primary"
                    >
                      worldnic.dexignlab.com
                    </Link>
                  </p>
                ...
                <div className="col-xl-5 col-xxl-6">
                  <div className="d-flex align-items-center mb-xl-4 mb-0 pb-3 justify-content-xl-end justify-content-start flex-wrap mt-xl-0 mt-3">
                    <div className="me-3">
                      <h4>WorldNIC</h4>
                      <p className="mb-0 text-xl-end text-start">
                        Software House
                      </p>
                    </div>
                  ...
                  <div className="d-flex align-items-center pt-sm-4 pt-0 flex-wrap justify-content-xl-end justify-content-start pe-3">
                    <div className="ms-0 my-3 my-sm-0 invite">
                      <Link
                        to={"#"}
                        className="btn btn-primary light  mb-sm-0 mb-2 me-2 btn-sm"
                        onClick={() => setShow(true)}
                      >
                        <i className="fas fa-user-plus me-3 scale2" />
                        Invite People
                      </Link>
                      <Link to={"#"} className="btn btn-primary light  btn-sm">
                        <i className="far fa-comment-alt scale2 me-3" />
                        45 Comments
                      </Link>
                    </div>
                    <ul className="kanbanimg1 ms-sm-3">
                      <li>
                        <img src={IMAGES.profilesmall1} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.profilesmall2} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.profilesmall3} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.profilesmall4} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.profilesmall5} alt="" />
                      </li>
                      <li>
                        <Link to={"#"}>5+</Link>
                      </li>
