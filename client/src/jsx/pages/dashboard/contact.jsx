        ...
        <div className="col-xl-12">
          <div className="row">
            {contactcarddata.map((data, i) => (
              <div
                className="col-xl-3 col-xxl-4 col-md-6 col-sm-6 items"
                key={i}
              >
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-3 text-start">
                        <h4 className="fs-16 font-w600 mb-0">
                          <Link to="/app-profile">{data.name}</Link>
                        </h4>
                        <p className="mb-2">@lincolndonin</p>
                        <div
                          className={`contact-footer ${id === data.id ? "show" : ""}`}
                          onClick={() => handleClick(data.id)}
                        >
                          <Link to={"#"}>View Profile</Link>
                          <ul>
                            <li>
                              <Link to={"#"}> {SVGICON.call} </Link>
                            </li>
                            <li>
                              <Link to={"#"}> {SVGICON.videocall} </Link>
                            </li>
                            <li>
