                ...
                {filemanagerfolderdata.map((data, index) => (
                  <div className="col-xl-3 col-sm-4" key={index}>
                    <div className="ic-folder-bx">
                      ...
                      <div className="d-flex align-items-center">
                        <span className="mb-0 me-2 text-dark font-w500">
                          245 Files
                        </span>
                      ...
                      <tbody>
                        {data.map((data, index) => (
                          <tr
                            ...
                            style={{
                              borderBottom: "1px solid rgba(82, 79, 79, 0.3)",
                            }}
                          >
                            <td className="sorting_1">
                              <div className=" d-flex align-items-center">
                                {SVGICON.folder}
                                <h6 className="mb-0 ms-2 fs-15">
                                  {" "}
                                  {data.file}{" "}
                                </h6>
                              </div>
