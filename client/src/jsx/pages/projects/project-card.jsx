              ...
              <div className="card-body">
                <div className="d-flex mb-4 align-items-start">
                  ...
                  <div className="me-auto">
                    ...
                    <h5 className="title font-w600 mb-2">
                      <Link to="/post-details" className="text-black">
                        Redesign Zenix Mobile App
                      </Link>
                    </h5>
                ...
                <div className="row mb-4">
                  <div className="col-sm-6 mb-sm-0 mb-3 d-flex">
                    ...
                    <div>
                      ...
                      <p className="mb-0 pt-1 font-w500 text-black">
                        Tuesday,Aug 15th 2024
                      </p>
                    </div>
                  </div>
                ...
                <div className="d-flex flex-wrap align-items-center">
                  <div className="me-auto mb-4">
                    ...
                    <ul className="users-lg">
                      <li>
                        <img src={IMAGES.userspic1} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.userspic2} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.userspic3} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.userspic4} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.userspic5} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.userspic6} alt="" />
                      </li>
                      <li>
                        <img src={IMAGES.userspic7} alt="" />
                      </li>
                    </ul>
                  </div>
                ...
                <div className="row">
                  <div className="col-6">
                    <div>
                      Questions:
                      <span className="text-black ms-3 font-w600">56</span>
                    </div>
                    <div>
                      Comments:
                      <span className="text-black ms-3 font-w600">200</span>
                    </div>
                  </div>
                  <div className="col-6">
                    <h6>
                    ...
                    <div className="progress mt-2">
                      <div
                        className={`progress-bar progress-animated ${data.class}`}
