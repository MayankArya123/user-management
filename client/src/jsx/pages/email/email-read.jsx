                  ...
                  <div className="col-xl-3 col-xxl-4 p-0">
                    <div className="border-end inbox-area-list">
                      <div className="d-flex align-items-center p-3">
                        ...
                        <div
                          className={`email-tools-box dz-resp-tool ms-auto float-end ${show ? "active" : ""}`}
                      ...
                      <div className="input-group contacts-search-1 mb-3">
                        <input
                          type="text"
                          className="form-control rounded-0 bg-transparent border-0"
                          placeholder="Search Worldnic..."
                        />
                        <span className="input-group-text rounded-0 bg-transparent border-0">
                          <Link to={"#"}>
                              ...
                              >
                                <div className="inbox">
                                  <div>
                                    ...
                                    <p>
                                      {" "}
                                      Hi Brian, Aliquip ipsum sunt sit sunt
                                      velit velit pariatur. Nisi incididunt
                                      eiusmod consequat ut cillum eu{" "}
                                    </p>
                                  </div>
                                  <span className="ms-auto d-flex align-items-center">
                                    <i className="fa-regular  text-warning fa-star me-1" />
                                    Jan
                                  </span>
                                </div>
                              </Nav.Link>
                            ...
                            <Nav.Item as="li" className="nav-item">
                              <Nav.Link eventKey="2" className="nav-link">
                                <div className="inbox">
                                  ...
                                  <span className="ms-auto d-flex align-items-center">
                                    <i className="fa-regular fa-star text-warning me-1" />{" "}
                                    Feb
                                  </span>
                                </div>
                              </Nav.Link>
                    ...
                    <div className="read-content-bx">
                      <div className=" d-xl-none d-flex align-items-center p-3">
                        ...
                        <div className="ms-auto">
                          <div className="dz-resp-tool dz-back-arrow me-2">
                            {" "}
                            <i className="fa-solid fa-arrow-left" />{" "}
                          </div>
                          <div className="email-tools-box dz-resp-tool">
                            {" "}
                            <i className="fa-solid fa-list-ul" />{" "}
                          </div>
                        </div>
                          ...
                          <div className=" ps-4 pe-3 py-4 ">
                            ...
                            <div className="read-content-body">
                              ...
                              <p className="mb-2">
                                ...
                                to leave for the far World of Grammar. Aenean
                          ...
                          <div className=" ps-4 pe-3 py-4 ">
                            <div className="d-flex align-items-center flex-wrap mb-3">
                              ...
                              <div>
                                <Link to={"#"}>
                                  {" "}
                                  <h6 className="mb-1">Samulas Jack </h6>{" "}
                                </Link>
                                <span>Web Doveloper</span>
                              </div>
                              <div className="read-content-attachment  ms-sm-auto ms-0">
