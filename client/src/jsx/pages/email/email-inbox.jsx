                    ...
                    <div role="toolbar" className="email-toolbar">
                      <div className="btn-group mb-1 ">
                        <div className="form-check custom-checkbox ">
                          <input
                            type="checkbox"
                            className="form-check-input message_input"
                            id="checkbox1"
                      ...
                      <div
                        className={`email-tools-box ${show ? "active" : ""}`}
                    ...
                    <div className="email-list mt-3">
                      {inboxdata.map((data, i) => (
                        <div className="message" key={i}>
                          <div>
                            <div
                              className={`d-flex message-single ${data.style}`}
                            >
                              <div className="ps-1 align-self-center">
                                <div className="form-check custom-checkbox">
                                  <input
                                    type="checkbox"
                                    className="form-check-input message_input1"
                                    onClick={() => chackboxFun()}
                                  />
                                  <label
                                    className="form-check-label"
