          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Alert
                variant="success"
                dismissible
                show={state.solidsuccess}
                className="solid"
              >
                <strong>Success!</strong> Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: "solidsuccess" })}
                ></button>
              </Alert>
              <Alert
                variant="info"
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Alert variant="secondary" dismissible show={state.dicsecondary}>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: "dicsecondary" })}
                ></button>
              </Alert>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              >
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: "soliddicsecondary" })}
                ></button>
              </Alert>
              <Alert
                variant="success"
          ...
          <Card>
            ...
            <Card.Body>
              ...
              >
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: "linksolidwarning" })}
                ></button>
              </Alert>
              <Alert
                variant="danger"
                dismissible
                show={state.linksoliddanger}
                className="solid"
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link
