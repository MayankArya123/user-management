    ...
    <Fragment>
      <div className="card card-comment">
        <div className="card-body pb-0">
          ...
          >
            <Link
              to={IMAGES.postimgfull2}
              data-src={IMAGES.postimgfull2}
              className="grid-item colspan-2 rowspan-3 lightimg"
            >
              <img src={IMAGES.postimgfull2} alt="" />
            </Link>
            <Link
              to={IMAGES.postimage4}
              data-src={IMAGES.postimage4}
              className="grid-item lightimg"
            >
              <img src={IMAGES.postimage4} alt="" />
            </Link>
            <Link
              to={IMAGES.postimage5}
              data-src={IMAGES.postimage5}
              className="grid-item lightimg"
            >
              <img src={IMAGES.postimage5} alt="" />
            </Link>
            <Link
              to={IMAGES.postimage6}
              data-src={IMAGES.postimage6}
              className="grid-item gallery-more lightimg"
              data-more="+3"
            >
