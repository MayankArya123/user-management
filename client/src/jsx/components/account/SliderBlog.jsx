...
function SliderBlog() {
  return (
    <Fragment>
      <div>
        <Swiper
          className="owl-carousel owl-theme card-carousel card-carousel-dots p-2 account-security-swiper"
          slidesPerView={1}
          spaceBetween={10}
          autoplay={{
            delay: 2000,
        ...
        >
          {sliderData.map((item, ind) => (
            <SwiperSlide className="item" key={ind}>
              ...
              <p className="mb-4">
                To start a blog, think of a topic about which you're passionate,
                brainstorm awesome ideas for your content
              </p>
