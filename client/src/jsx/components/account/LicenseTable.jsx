        ...
        <div className="card-header border-0 py-3">
          ...
          <div className="clearfix d-flex align-items-center">
            ...
            <div className="dt-buttons">
              <button
                className="dt-button buttons-excel buttons-html5 btn btn-primary tp-btn-light btn-sm mb-0 me-0"
                type="button"
              >
                <span>
                  <i className="las la-file" /> Export Report
                </span>
              </button>
            </div>
          </div>
        ...
        <div className="card-body p-0">
          <div className="table-responsive active-projects">
            <div className="dataTables_wrapper no-footer" id="license_table">
              <table
                className="table mb-4 table-striped-thead table-wide table-sm dataTable no-footer"
                    ...
                    <tr key={index} className={item.addclass}>
                      ...
                      <td>
                        <div className="select-text-wrap d-flex justify-content-between">
                          ...
                          <button
                            className="btn-select-text btn p-0 border-0 ms-4"
