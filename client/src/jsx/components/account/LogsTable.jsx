  ...
  return (
    <Fragment>
      <div className="dataTables_wrapper no-footer" id="applications-data">
        <table
          id="tableLogs"
          className="table mb-4 table-striped-thead table-wide table-sm dataTable no-footer text-nowrap"
        >
          <thead>
            <tr>
              <th
              ...
              <th
                className="sorting c-pointer"
                onClick={() => sortData("platform")}
              >
                Device
              </th>
              <th className="sorting c-pointer" onClick={() => sortData("ip")}>
                IP Address
              </th>
              <th
                className="text-end sorting c-pointer"
