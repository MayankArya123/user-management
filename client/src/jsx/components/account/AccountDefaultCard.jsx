...
const ProfileProgress = lazy(
  () => import("../../components/profile/ProfileProgress"),
);
        ...
        <div className="clearfix d-xl-flex flex-grow-1">
          <div className="clearfix pe-md-5">
            <h3 className="fw-semibold mb-1">
              {" "}
              Atkinson <img src={IMAGES.blueTick} alt="Blue Tick" />
            </h3>
          ...
          {ProfilePages.map((ele, ind) => (
            <li className="nav-item ms-1" key={ind}>
              <Link
                ...
                className={`nav-link py-3 border-3 text-black ${activePage === ele.pageurl ? "active" : ""}`}
              >
                {ele.pagename}
              </Link>
            </li>
